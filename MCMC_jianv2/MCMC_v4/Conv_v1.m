...
input_info.velocity.u.sigmavec = linspace(4, 8, 100);
...
Mu(n, i, m) = out.mu_obszp;
Sigma(n, i, m) = out.sigma_obszp;
...
figure; plot(input_info.velocity.u.sigmavec, Sigma);
