function [ZFFT, PT, mu, sigma, vel_axis, dv, v_amb] = Spec(z_model, Nt, dt, lambda, SNR_db, isplot, mi, ci)
...
dtext = ['Nt = ', num2str(Nt), ', dv = ', num2str(dv), ' [m/s]', ', \sigma_{re} = ', num2str(sigma), ' [m/s]'];
xl = 'velocity [m/s]';
