function [data, data_f, data_f_full, data_full] = DS_simulatorV2_with_az(SNR, m0, mu_max, sigma, n, v_amb, N, phi, beta_wind, X_full, Theta_full)

%% N is the number of Doppler bins permitted for a specific rotation speed and radar beam width 
mu = mu_max .* cos(beta_wind - phi);
