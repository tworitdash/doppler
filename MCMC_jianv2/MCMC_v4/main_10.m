...
llinfo.velocity.u.muvec = 0:llinfo.v_ambscan/2000:llinfo.v_amb; %linspace(eps, llinfo.v_amb, llinfo.Nutest);
llinfo.plot_geo = 0;

llinfo.t_known = 0; % 1 if time instances are known: 0 if not known
