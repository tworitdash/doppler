...
% txt = ['SNR = ', num2str(db(SNR)/2), ' dB', ', BeamWidth = ', num2str(BW_deg), '^{\circ}', ', \Omega = ', num2str(Omega_rpm(i)), ' [rpm]'];
...
% title(['Doppler Spectrum [dB] at SNR = ', num2str(db(SNR)/2), ' dB', ', BeamWidth = ', num2str(BW_deg), '^{\circ}', ', \Omega = ', num2str(Omega_rpm(i)), ' [rpm]'], 'FontSize', 12, 'FontWeight', 'bold');
% 
