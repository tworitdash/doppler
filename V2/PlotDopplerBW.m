function [] = PlotDopplerBW(BW_deg, v_mean_e, v_spread_e, SI, OI, PI, SNR_db, Omega_rpm, mean_Phi)
    ...
    title(['Error in Mean Doppler velocity at ', num2str(Omega_interest), 'RPM', ', \Phi = ', num2str(Phi_interest), ' deg', ', SNR = ', num2str(SNR_interest), ' dB'], 'FontSize', 16);
    ...
    title(['Error in Doppler spectrum width at ', num2str(Omega_interest), 'RPM', ', \Phi = ', num2str(Phi_interest), ' deg'', SNR = ', num2str(SNR_interest), ' dB'], 'FontSize', 16);
