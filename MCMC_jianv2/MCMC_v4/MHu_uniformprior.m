function [accepted, rejected, itern, E, sample_MC_seq, sample_all, Flag, NB] = MHu_uniformprior(E, iter, data, t_avail, x0, sigma_n, epislon)
...
% updated
    ...
    sample_MC_seq = zeros(1, iter);
    sample_all = zeros(1, iter);
...
%     figure(fig2); histogram(normrnd(E.gt(3), E.gt(4), [1 5000]));
    ...
    for i = 1:iter
        ...
        [x_new, pxnew, px] = TMu_uniformprior(E);     % x_new is a new sample drawn for u 
