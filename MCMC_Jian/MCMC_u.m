...
plot(1:Num_Simu, sample_all,'b--',...
    1:Num_Simu, sample_MC_seq, 'r-',...
    1:Num_Simu, u*ones(1,Num_Simu), 'g-.','linewidth',1.2)
legend('Monter Carlo samples','MC sequence','Gound truth')
xlabel('Indices of all the samples')
ylabel('Value of the sequences')
title('Sequences of MC')
...
%    Mest(i) = mean(accepted(:, i));
   ...
   figure(3000+i); histogram(rejected(burninrej+1:end, i), 100);       % histogram for rejected
