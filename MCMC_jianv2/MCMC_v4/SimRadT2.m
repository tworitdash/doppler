...
function [out] = SimRadT2(input_info)
...
%     v = normrnd(input_info.velocity.v.mu, input_info.velocity.v.sigma, [1 input_info.NScatters]);
      u = [input_info.velocity.u.mu input_info.velocity.u.mu + input_info.velocity.u.sigma];
      v = [input_info.velocity.v.mu input_info.velocity.v.mu + input_info.velocity.v.sigma];
end
