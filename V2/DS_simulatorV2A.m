function [data, data_f, data_f_full, data_full, X, Theta, vel_axis_permitted, dv] = DS_simulatorV2A(SNR, m0, mu, sigma, n, v_amb, N,  X, Theta)
...
P_full = -(S_); % .* log(X_full); % Power spectrum
